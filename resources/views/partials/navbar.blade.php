<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form class="d-flex" role="search" action="/site/protudos/pesquisa" method="POST">
                @csrf
                <input class="form-control me-2" type="search" id="pesquisa" name="pesquisa" placeholder="Digite o nome do produto" aria-label="Digite o nome do produto">
